...
void ComputeMassProperties (const VertexSource<Real> * vertices, int numTriangles,
...
void ComputeMassProperties<float> (const VertexSource<float> * , int, const int*,
    bool, float&, Vector3<float>&, Matrix3<float>&);

template WM5_MATHEMATICS_ITEM
void ComputeMassProperties<double> (const VertexSource<double> * , int, const int*,
