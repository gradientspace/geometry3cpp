...
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real> Matrix3<Real>::TransposeTimes(const Vector3<Real>& vec) const
{
	return Vector3<Real>
	(
		mEntry[0] * vec[0] + mEntry[3] * vec[1] + mEntry[6] * vec[2],
		mEntry[1] * vec[0] + mEntry[4] * vec[1] + mEntry[7] * vec[2],
		mEntry[2] * vec[0] + mEntry[5] * vec[1] + mEntry[8] * vec[2]
	);
}
//----------------------------------------------------------------------------
template <typename Real>
