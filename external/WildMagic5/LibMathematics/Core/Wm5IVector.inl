...
//----------------------------------------------------------------------------
template <int VSIZE>
inline IVector<VSIZE>::operator const int* () const
{
    return mTuple;
}
//----------------------------------------------------------------------------
template <int VSIZE>
inline IVector<VSIZE>::operator int* ()
{
    return mTuple;
}
//----------------------------------------------------------------------------
template <int VSIZE>
inline const int& IVector<VSIZE>::operator[] (int i) const
{
...
//----------------------------------------------------------------------------
template <int VSIZE>
inline int& IVector<VSIZE>::operator[] (int i)
{
    assertion(0 <= i && i < VSIZE, "Invalid index\n");
    return mTuple[i];
}
...
//----------------------------------------------------------------------------
template <int VSIZE>
IVector<VSIZE> IVector<VSIZE>::operator* (const int& scalar) const
{
    IVector<VSIZE> prod;
    for (int i = 0; i < VSIZE; ++i)
    {
...
//----------------------------------------------------------------------------
template <int VSIZE>
IVector<VSIZE>& IVector<VSIZE>::operator*= (const int& scalar)
{
    for (int i = 0; i < VSIZE; ++i)
    {
        mTuple[i] *= scalar;
...
//----------------------------------------------------------------------------
template <int VSIZE>
int IVector<VSIZE>::SquaredLength () const
{
    int sqrLen = 0;
    for (int i = 0; i < VSIZE; ++i)
    {
...
//----------------------------------------------------------------------------
template <int VSIZE>
int IVector<VSIZE>::Dot (const IVector& vec) const
{
    int dot = 0;
    for (int i = 0; i < VSIZE; ++i)
    {
